 ...
 *      String from = "subscription-dept@localhost";
 *      String to = "ltree8@localhost";
 ...
 *      ServletContext application = getServletContext();      // inherited from GenericServlet
 *
 *      // Attach two files stored in our web app directory "/pubs/"
 *      //
 *      //  Need to retrieve the complete filesystem path for the files
 *      //  (ie c:\crs570\ex22\WebContent\pubs\java_courses.pdf)
 *      //  Accomplished with application.getRealPath(...).
 *      //
 *      //  The method application.getRealPath(...) will return the root directory for
 *      //  your web application, for example "c:\crs570\ex22\WebContent".
 *      //  It will also append the String parameter that is passed in.
 *      //
 *      fileNamesList[0] = application.getRealPath("/pubs/java_courses.pdf");
 *      fileNamesList[1] = application.getRealPath("/pubs/xml_courses.pdf");
 *
 *      try {
...
public class EzMailer {
	 ...
	 *  @param toEmailList addresses of the recipients
	 ...
	 */
	public static void sendMessageAttach(
		String smtpHost,
		String from,
		String[] toEmailList,
		String subject,
